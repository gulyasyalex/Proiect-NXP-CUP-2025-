...
public:
    ...
    double carBoostExitCornerSpeed(double new_car_speed, double _turn_angle, double boostSpeedValue);
    ...
    double CalculateCarSpeed(double _min_speed, double _max_speed, double _wheel_base, double _friction_coefficient, double _downward_acceleration, double _turn_angle, double boostSpeedValue);
